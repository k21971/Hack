...
const char *const shkliquors[] = {
    ...
    /* Silezie */
    "Walbrzych", "Swidnica", "Klodzko", "Raciborz", "Gliwice", "Brzeg", "Krnov",
    "Hradec Kralove",
    /* Schweiz */
...
const char *const shkrings[] = {
    ...
    "Rovaniemi", "Avasaksa", "Haparanda", "Lulea", "Gellivare", "Oeloe",
    "Kajaani", "Fauske", 0};
...
const char *const shkfoods[] = {
    ...
    "Bojolali",    "Sarangan",      "Ngebel",
    "Djombang",    "Ardjawinangun", "Berbek",
    "Papar",       "Baliga",        "Tjisolok",
    "Siboga",      "Banjoewangi",   "Trenggalek",
    "Karangkobar", "Njalindoeng",   "Pasawahan",
    "Pameunpeuk",  "Patjitan",      "Kediri",
    "Pemboeang",   "Tringanoe",     "Makin",
    "Tipor",       "Semai",         "Berhala",
    "Tegal",       "Samoe",         0};
...
const char *const shkweapons[] = {
    ...
    "Picq",         "Urignac",   "Corignac",   "Fleac",
    "Lonzac",       "Vergt",     "Queyssac",   "Liorac",
    "Echourgnac",   "Cazelon",   "Eypau",      "Carignan",
    "Monbazillac",  "Jonzac",    "Pons",       "Jumilhac",
    "Fenouilledes", "Laguiolet", "Saujon",     "Eymoutiers",
    "Eygurande",    "Eauze",     "Labouheyre", 0};

/* MODERN: CONST-CORRECTNESS: shkgeneral is a read-only array of string literals
 */
const char *const shkgeneral[] = {"stuff",      "things",     "goods",
                                  "provisions", "implements", 0};

struct shk_nx {
  char x;
  /* MODERN: CONST-CORRECTNESS: shopkeeper name arrays are read-only */
  const char *const *xn;
} shk_nx[] = {{POTION_SYM, shkliquors}, {SCROLL_SYM, shkbooks},
              {ARMOR_SYM, shkarmors},   {WAND_SYM, shkwands},
              {RING_SYM, shkrings},     {FOOD_SYM, shkfoods},
              {WEAPON_SYM, shkweapons}, {0, shkgeneral}};
